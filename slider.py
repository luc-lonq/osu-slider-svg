...
class Slider:
    ...
    def svg_path(self, filename="slider_path.svg"):

        def draw_bezier_curve(dwg, control_points, translate_fn):
        ...
        def draw_segment(dwg, p1, p2, translate_fn):
        ...
        def draw_point(dwg, point, index, translate_fn):
            ...
            color = "red" if point.anchor else "black"
